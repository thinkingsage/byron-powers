...
### Planning Track Reference Files

- **references/concept-and-audience.md** — Develop your core idea into a compelling book concept with a defined audience, scope, and value proposition
- **references/technology-landscape.md** — Research existing books, competing resources, market timing, and positioning for your technical topic
- **references/book-architecture.md** — Design the table of contents, chapter structure, learning progression, and dependency graph
- **references/proposal-and-pitch.md** — Write a publisher-ready book proposal or self-publishing plan with market analysis and sample chapter
- **references/voice-and-style.md** — Define and maintain a consistent technical writing voice, code style, and pedagogical approach
...
### Writing Track Reference Files

- **references/explanation-craft.md** — Techniques for explaining complex technical concepts with clarity, precision, and appropriate depth
- **references/code-examples.md** — Design, write, test, and maintain code examples that teach effectively and actually run
- **references/visuals-and-diagrams.md** — Plan and describe diagrams, architecture figures, screenshots, and visual explanations
- **references/chapter-drafting.md** — Write chapters systematically with attention to pacing, learning objectives, and forward momentum
- **references/running-example.md** — Design and maintain a cohesive example project that threads through the book and grows with the reader
...
### Production Track Reference Files

- **references/technical-review.md** — Manage the technical review process, incorporate feedback, and resolve conflicting reviewer opinions
- **references/revision-and-polish.md** — Systematically revise for technical accuracy, prose clarity, code correctness, and consistency
- **references/production-prep.md** — Prepare the manuscript for the publisher's production pipeline including formatting, indexing, and final checks
- **references/launch-and-marketing.md** — Plan the book launch, build an audience, and maintain the book post-publication
