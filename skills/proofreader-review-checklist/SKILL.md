...
description: Use when the user asks to "proofread", "review my manuscript", "check my chapter", "proofread my outline", "review my query letter", "proofread my proposal", "check consistency", "review my character sheet", or needs a structured checklist for reviewing writing documents — manuscript chapters, outlines, proposals, query letters, or world-building docs — produced by the novelty, technical-author, or book-agent-publicist skills.
version: 0.1.0
---
...
This skill provides structured checklists for proofreading and reviewing writing workspace documents. It adapts to the document type — manuscript chapters, outlines, proposals, query letters, character sheets, and more — so every review is focused and consistent.
...
### Manuscript Chapter (fiction or technical)
...
### Book Proposal (technical or narrative non-fiction)
...
### Character Sheet or World-Building Document
